...
public class Main {
    public static void main(String[] args) {
        ...
        clienti[0] = new Cliente("Coglionazzo",32,0);
        clienti[1] = new Cliente("Matrialone",65,100);
        clienti[2] = new Cliente("Pisellone",40,10);
        ...
        negozio.aumentaQuantita(prodotti[0],2);
        negozio.aggiungiProdotto(new Prodotto(3,"Biscotti",2,TipoProdotto.alimentari));
