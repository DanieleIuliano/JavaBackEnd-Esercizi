...
public class Filtraggio {
        ...
        public void FiltroBiancoNero(BufferedImage immagineIniziale) throws Exception {
            ...
            immagineIniziale = immagineModificata;

        }

        public void filtroAspecchio(BufferedImage immagineIniziale) throws Exception {
            //apre un immagine e la mette in immagineIniziale
        ...
        public void filtroGBR(BufferedImage immagineIniziale) throws Exception {
            //apre un immagine e la mette in immagineIniziale
        ...
        public void filtroNegativo(BufferedImage immagineIniziale) throws Exception {
            //apre un immagine e la mette in immagineIniziale
        ...
        public void filtroposterize(int num,BufferedImage imageIniziale) throws Exception {
            //crea immagine
